...
def inisiate_data_transformation(train_path,test_path):
    try:
        ...
        train_array_path = os.path.join("Data/procrss", "train_array.npy")
        test_array_path = os.path.join("Data/procrss", "test_array.npy")
        ...
        x_train_transform=final.fit_transform(x_train).toarray()
        x_test_transform=final.transform(x_test).toarray()
